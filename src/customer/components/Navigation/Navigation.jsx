      ...
      <Transition show={open}>
        <Dialog className="relative z-50 lg:hidden" onClose={setOpen}>
          ...
          <div className="fixed inset-0 z-50 flex">
            ...
            >
              <DialogPanel className="relative flex w-full z-[1] max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                          ...
                          <div className="relative flex">
                            <PopoverButton
                              className={classNames(
                                ...
                                "relative z-[1] flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out"
                              )}
                            >
                              {category.name}
                            </PopoverButton>
