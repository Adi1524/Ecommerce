...
export default function Product() {
  ...
  const handleFilter = (value, sectionId) => {
    ...
    // Get the current filter value for the given sectionId
    let filterValue = searchParams.get(sectionId);

    if (filterValue) {
      // Convert the filter value to an array
      ...
      // If no filter value exists for this section, create a new one
                          ...
                          <div className="space-y-4">
                            {section.options.map((option, optionIdx) => (
                              ...
                              >
                                <input
                                  onChange={() => {
                                    handleFilter(option.value, section.name);
                                  }}
